  ...
  const calculateManagementPlan = () => {
    ...
    setResult({
      ...
      lifestyleChanges: [
        ...
        '❄️ Avoid extreme cold exposure (triggers sickling)',
        '🏔️ Avoid high altitude >1500m (hypoxia trigger)',
        '✈️ Use supplemental O₂ on flights >2 hours',
        '🌡️ Maintain warm environment (18-24°C optimal)',
      ...
      hydrationProtocol: [
        ...
        '☀️ Increase by 500-1000ml in hot weather',
        ...
        '⚖️ Track daily weight (dehydration indicator)',
        '🌡️ Increase fluids with fever or infection'
      ],
      ...
      supplements: [
        ...
        '⚕️ Hydroxyurea: If ≥3 crises/year (consult hematologist)'
      ],

      crisisPrevention: [
        '🌡️ Treat infections promptly (common trigger)',
        '💧 Maintain hydration constantly',
        '❄️ Dress warmly in cold weather',
        '😴 Avoid sleep deprivation',
        '🚫 Avoid alcohol and recreational drugs',
        '💊 Take prescribed medications regularly (hydroxyurea if indicated)',
        '🩺 Regular penicillin prophylaxis if prescribed',
        '🌡️ Monitor temperature - seek care if >38°C',
      ...
      ulcerManagement: hasUlcers ? [
        ...
        `⏱️ Estimated healing: ${healingWeeks} weeks with optimal care`,
        ...
        '⬆️ Elevation: Leg elevation when resting',
      ...
      monitoringSchedule: [
        ...
        '👁️ Ophthalmology: Annually (retinopathy screening)',
      ...
      urgentWarnings: [
        ...
        '⚠️ Any concerning new symptom in SCD patient'
      ]
    });
  };
